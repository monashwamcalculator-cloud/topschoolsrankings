...
for uni in universities:
    ...
    # using png instead of webp if webp is not provided by clearbit natively
    logo_url = f"https://logo.clearbit.com/{uni['domain']}"
    try:
        urllib.request.urlretrieve(logo_url, logo_path)
        print(f"Created {uni['id']} and downloaded logo")
