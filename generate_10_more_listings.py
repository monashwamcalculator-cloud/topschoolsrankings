...
universities = [
    {
        ...
        'short_desc': 'Public research university in Boulder, Colorado, known for aerospace engineering, environmental sciences, and a stunning Rocky Mountain campus.',
        'desc_p1': 'The University of Colorado Boulder (CU Boulder) is a public research university in Boulder, Colorado. Founded in 1876, five months before Colorado became a state, it is the flagship university of the University of Colorado system.',
        'desc_p2': 'Undergraduate admission is competitive. Prospective students should review specific college requirements on colorado.edu. CU Boulder is accredited by the Higher Learning Commission (HLC).',
        'address': 'Boulder, CO 80309',
        'established': '1876',
        'courses': 'Undergraduate and graduate programmes across engineering, business, environmental sciences, and arts.',
        'phone': '303-492-1411',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in Tucson, Arizona, recognized for its space sciences, optics, and medical programmes.',
        'desc_p1': 'The University of Arizona (UArizona) is a public land-grant research university in Tucson, Arizona. Founded in 1885, it was the first university in the Arizona Territory and has grown into a major research institution.',
        'desc_p2': 'Undergraduate admission is selective. Prospective students should review the requirements on arizona.edu. The University of Arizona is accredited by the WASC Senior College and University Commission (WSCUC).',
        'address': 'Tucson, AZ 85721',
        'established': '1885',
        'courses': 'Undergraduate and graduate programmes across astronomy, optical sciences, medicine, and business.',
        'phone': '520-621-2211',
    ...
    },
    {
        ...
        'short_desc': 'Public research university in the Phoenix metropolitan area, highly regarded for innovation, large enrollment, and online education.',
        'desc_p1': 'Arizona State University (ASU) is a public research university in the Phoenix metropolitan area. Founded in 1885, it is one of the largest public universities by enrollment in the United States, famous for its innovative model of higher education.',
        'desc_p2': 'Undergraduate admission is accessible but competitive for certain professional programs. Prospective students should review requirements on asu.edu. ASU is accredited by the Higher Learning Commission (HLC).',
        'address': 'Tempe, AZ 85281',
        'established': '1885',
        'courses': 'Undergraduate and graduate programmes across journalism, business, engineering, and sustainability.',
        'phone': '855-278-5080',
        'accreditation': 'Accredited by the Higher Learning Commission (HLC)',
        'domain': 'asu.edu',
    ...
    },
    {
        ...
        'short_desc': 'Public research university in Salt Lake City, Utah, notable for medicine, computer science, and strong health care systems.',
        'desc_p1': 'The University of Utah (The U) is a public research university in Salt Lake City, Utah. Founded in 1850, it is the flagship institution of the Utah System of Higher Education and a prominent center for medical research.',
        'desc_p2': 'Undergraduate admission is competitive. Prospective students should review the requirements on utah.edu. The University of Utah is accredited by the Northwest Commission on Colleges and Universities (NWCCU).',
        'address': '201 Presidents Cir, Salt Lake City, UT 84112',
        'established': '1850',
        'courses': 'Undergraduate and graduate programmes across medicine, engineering, law, and business.',
        'phone': '801-581-7200',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in Athens, Georgia, renowned for its historic campus, business, and journalism programmes.',
        'desc_p1': 'The University of Georgia (UGA) is a public land-grant research university in Athens, Georgia. Chartered in 1785, it is one of the oldest public universities in the United States and the flagship institution of the University System of Georgia.',
        'desc_p2': 'Undergraduate admission is highly competitive. Prospective students should review requirements on uga.edu. UGA is accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC).',
        'address': 'Athens, GA 30602',
        'established': '1785',
        'courses': 'Undergraduate and graduate programmes across business, journalism, law, veterinary medicine, and agriculture.',
        'phone': '706-542-3000',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in Raleigh, North Carolina, leading in engineering, textiles, and design.',
        'desc_p1': 'North Carolina State University (NC State) is a public land-grant research university in Raleigh, North Carolina. Founded in 1887, it is part of the Research Triangle and is the largest university in the Carolinas.',
        'desc_p2': 'Undergraduate admission is competitive, particularly in engineering and sciences. Prospective students should review specific college requirements on ncsu.edu. NC State is accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC).',
        'address': 'Raleigh, NC 27695',
        'established': '1887',
        'courses': 'Undergraduate and graduate programmes across engineering, textiles, agriculture, design, and veterinary medicine.',
        'phone': '919-515-2011',
        'accreditation': 'Accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC)',
        'domain': 'ncsu.edu',
    ...
    },
    {
        'id': 'virginia-tech',
        'name': 'Virginia Tech',
        'short_desc': 'Public land-grant research university in Blacksburg, Virginia, well known for its engineering, architecture, and strong corps of cadets.',
        'desc_p1': 'Virginia Polytechnic Institute and State University (Virginia Tech) is a public land-grant research university with its main campus in Blacksburg, Virginia. Founded in 1872, it offers a robust portfolio of degree programs and is one of the few senior military colleges in the US.',
        'desc_p2': 'Undergraduate admission is competitive. Prospective students should review major-specific requirements on vt.edu. Virginia Tech is accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC).',
        'address': 'Blacksburg, VA 24061',
        'established': '1872',
        'courses': 'Undergraduate and graduate programmes across engineering, architecture, agriculture, business, and veterinary medicine.',
        'phone': '540-231-6000',
        'accreditation': 'Accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC)',
        'domain': 'vt.edu',
    ...
    },
    {
        ...
        'short_desc': 'Public research university in Tallahassee, Florida, famous for its programs in criminal justice, film, and meteorology.',
        'desc_p1': 'Florida State University (FSU) is a public research university in Tallahassee, Florida. Founded in 1851, it is a senior member of the State University System of Florida and is recognized for its comprehensive academic offerings and research facilities.',
        'desc_p2': 'Undergraduate admission is selective. Prospective students should review specific requirements on fsu.edu. FSU is accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC).',
        'address': 'Tallahassee, FL 32306',
        'established': '1851',
        'courses': 'Undergraduate and graduate programmes across law, business, motion picture arts, criminology, and sciences.',
        'phone': '850-644-2525',
        'accreditation': 'Accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC)',
        'domain': 'fsu.edu',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in Amherst, Massachusetts, celebrated for its computer science, business, and dining services.',
        'desc_p1': 'The University of Massachusetts Amherst (UMass Amherst) is a public land-grant research university in Amherst, Massachusetts. Founded in 1863, it is the flagship campus of the University of Massachusetts system and part of the Five College Consortium.',
        'desc_p2': 'Undergraduate admission is competitive. Prospective students should review specific major requirements on umass.edu. UMass Amherst is accredited by the New England Commission of Higher Education (NECHE).',
        'address': 'Amherst, MA 01003',
        'established': '1863',
        'courses': 'Undergraduate and graduate programmes across computer science, business, engineering, public health, and social sciences.',
        'phone': '413-545-0111',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in Storrs, Connecticut, known for strong athletics, health sciences, and education programmes.',
        'desc_p1': 'The University of Connecticut (UConn) is a public land-grant research university in Storrs, Connecticut. Founded in 1881, it is the flagship university of the state and part of the Universitas 21 global network of research universities.',
        'desc_p2': 'Undergraduate admission is competitive. Prospective students should review requirements on uconn.edu. UConn is accredited by the New England Commission of Higher Education (NECHE).',
        'address': 'Storrs, CT 06269',
        'established': '1881',
        'courses': 'Undergraduate and graduate programmes across business, education, nursing, pharmacy, and engineering.',
        'phone': '860-486-2000',
        'accreditation': 'Accredited by the New England Commission of Higher Education (NECHE)',
        'domain': 'uconn.edu',
        'url': 'https://uconn.edu/'
...
for uni in universities:
    ...
    google_url = f"https://www.google.com/s2/favicons?domain={uni['domain']}&sz=256"
    ddg_url = f"https://icons.duckduckgo.com/ip3/{uni['domain']}.ico"
    
    try:
        urllib.request.urlretrieve(google_url, logo_path)
        print(f"Downloaded Google logo for {uni['id']}")
    except Exception as e:
        print(f"Google favicon failed for {uni['id']}, trying DuckDuckGo...")
        try:
            urllib.request.urlretrieve(ddg_url, logo_path)
            print(f"Downloaded DuckDuckGo logo for {uni['id']}")
        except Exception as e2:
            print(f"Both logo APIs failed for {uni['id']}: {e2}")
            # Use fallback site logo
            try:
                with open("assets/logo.png", "rb") as src, open(logo_path, "wb") as dst:
                    dst.write(src.read())
            except:
                pass
