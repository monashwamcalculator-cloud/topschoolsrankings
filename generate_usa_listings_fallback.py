...
universities = [
    {
        ...
        'short_desc': 'Public land-grant research university in West Lafayette, Indiana, known for its highly ranked engineering, agriculture and aviation programmes.',
        'desc_p1': 'Purdue University is a public land-grant research university in West Lafayette, Indiana, and the flagship campus of the Purdue University system. Founded in 1869, it is renowned for its STEM disciplines, particularly engineering, aeronautics, and agriculture, alongside strong programmes in business and the liberal arts.',
        'desc_p2': 'Undergraduate admission is competitive. Prospective students should review specific college requirements, particularly for engineering and computer science, on purdue.edu. Purdue is accredited by the Higher Learning Commission (HLC). International applicants must verify English proficiency requirements.',
        'address': '610 Purdue Mall, West Lafayette, IN 47907',
        'established': '1869',
        'courses': 'Undergraduate and graduate programmes across engineering, agriculture, science, business, liberal arts, and health sciences.',
        'phone': '765-494-4600',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in Gainesville, Florida, offering extensive undergraduate and graduate programmes.',
        'desc_p1': 'The University of Florida (UF) is a public land-grant research university in Gainesville, Florida. Founded in 1853, it is a senior member of the State University System of Florida and is known for its comprehensive academic offerings, large campus, and strong athletic programmes.',
        'desc_p2': 'Undergraduate admission is highly selective. Prospective students should review specific college requirements and deadlines on ufl.edu. The University of Florida is accredited by the Southern Association of Colleges and Schools Commission on Colleges (SACSCOC). International applicants must meet specific language and documentation criteria.',
        'address': 'Gainesville, FL 32611',
        'established': '1853',
        'courses': 'Undergraduate and graduate programmes across engineering, business, medicine, law, agriculture, and liberal arts and sciences.',
        'phone': '352-392-3261',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in Madison, Wisconsin, known for extensive research output and strong academic programmes.',
        'desc_p1': 'The University of Wisconsin–Madison is a public land-grant research university in Madison, Wisconsin. Founded when Wisconsin achieved statehood in 1848, it is the official state university of Wisconsin and the flagship campus of the University of Wisconsin System.',
        'desc_p2': 'Admission to UW-Madison is competitive. Prospective students should review college-specific prerequisites and application deadlines on wisc.edu. The university is accredited by the Higher Learning Commission (HLC). International students must verify English language proficiency requirements.',
        'address': 'Madison, WI 53706',
        'established': '1848',
        'courses': 'Undergraduate and graduate programmes across letters and science, engineering, agriculture, business, and education.',
        'phone': '608-263-2400',
        'accreditation': 'Accredited by the Higher Learning Commission (HLC)',
        'domain': 'wisc.edu',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in La Jolla, California, known for STEM, oceanography, and a unique residential college system.',
        'desc_p1': 'The University of California, San Diego (UC San Diego) is a public land-grant research university in San Diego, California. Established in 1960 near the pre-existing Scripps Institution of Oceanography, it is recognized as a Public Ivy and is a prominent campus of the University of California system.',
        'desc_p2': 'Undergraduate admission is highly selective. Prospective students should review the UC application process and specific major requirements on ucsd.edu. UC San Diego is accredited by the WASC Senior College and University Commission (WSCUC). International applicants must meet UC system-wide English proficiency standards.',
        'address': '9500 Gilman Dr, La Jolla, CA 92093',
        'established': '1960',
        'courses': 'Undergraduate and graduate programmes across engineering, biological sciences, physical sciences, social sciences, and medicine.',
        'phone': '858-534-2230',
    ...
    },
    {
        ...
        'short_desc': 'Public land-grant research university in College Park, Maryland, near Washington, D.C., known for research and strong academic programmes.',
        'desc_p1': 'The University of Maryland, College Park (UMD) is a public land-grant research university in College Park, Maryland. Founded in 1856, it is the flagship institution of the University System of Maryland and the largest university in both the state and the Washington metropolitan area.',
        'desc_p2': 'Undergraduate admission is competitive. Prospective students should review specific college requirements and deadlines on umd.edu. The University of Maryland is accredited by the Middle States Commission on Higher Education (MSCHE). International applicants must fulfill specific language and documentation criteria.',
        'address': 'College Park, MD 20742',
        'established': '1856',
        'courses': 'Undergraduate and graduate programmes across engineering, computer science, business, behavioural and social sciences, and arts and humanities.',
        'phone': '301-405-1000',
...
print("Listings rewritten with lettermark.")
