import os
os.makedirs('author/samrat-biswas', exist_ok=True)
html = '''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Samrat Biswas | Top Schools Rankings</title><meta name="description" content="Samrat Biswas is a distinguished VP of Operations, Engineering, and Growth at Unified Infotech, renowned for his deep expertise in scaling teams and refining processes."><meta name="robots" content="index, follow"><link rel="canonical" href="https://topschoolsrankings.com/author/samrat-biswas/"><meta name="google-adsense-account" content="ca-pub-5825245351059712"><meta property="og:type" content="website"><meta property="og:site_name" content="Top Schools Rankings"><meta property="og:title" content="Samrat Biswas"><meta property="og:description" content="Samrat Biswas is a distinguished VP of Operations, Engineering, and Growth at Unified Infotech, renowned for his deep expertise in scaling teams and refining processes."><meta property="og:url" content="https://topschoolsrankings.com/author/samrat-biswas/"><meta property="og:image" content="https://topschoolsrankings.com/og.png"><meta name="twitter:card" content="summary_large_image"><meta name="twitter:image" content="https://topschoolsrankings.com/og.png"><link rel="icon" href="/favicon.jpg"><link rel="stylesheet" href="/assets/site.css"><script async crossorigin="anonymous" src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5825245351059712"></script><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","name":"Samrat Biswas","description":"Samrat Biswas is a distinguished VP of Operations, Engineering, and Growth at Unified Infotech, renowned for his deep expertise in scaling teams and refining processes.","image":"https://topschoolsrankings.com/og.png","url":"https://topschoolsrankings.com/author/samrat-biswas/","publisher":{"@type":"Organization","name":"Top Schools Rankings","url":"https://topschoolsrankings.com"}}</script><script src="/assets/site.js" defer></script></head><body>
  ...
  <nav class="breadcrumbs site-container" aria-label="Breadcrumb"><a href="/">Home</a><span><i aria-hidden="true">/</i><b>Samrat Biswas</b></span></nav>
  <header class="page-header">
  <div class="site-container narrow" style="display:flex; flex-direction:column; align-items:center; text-align:center;">
    <img src="/assets/samrat-biswas.jpg" alt="Samrat Biswas" style="width:150px; height:150px; border-radius:50%; object-fit:cover; margin-bottom:20px; box-shadow:0 4px 10px rgba(0,0,0,0.1);">
    <span class="eyebrow">Guest Contributor</span>
    <h1 style="margin-bottom:10px;">Samrat Biswas</h1>
    <p style="font-size:18px; color:#4a5568; max-width:800px; line-height:1.6;">Samrat Biswas is a distinguished VP of Operations, Engineering, and Growth at Unified Infotech, renowned for his deep expertise in scaling teams and refining processes. Samrat's writings are informed by his wealth of experience, offering readers valuable insights into the intricacies of engineering leadership, operational efficiency, and driving transformational change within organizations.</p>
    <div style="margin-top:20px; display:flex; gap:15px; flex-wrap:wrap; justify-content:center;">
      <a href="https://www.unifiedinfotech.net/" target="_blank" rel="noopener noreferrer" style="color:#2b6cb0; text-decoration:none; font-weight:600;">Company Website</a>
      <a href="https://www.samratbiswas.com/thoughts" target="_blank" rel="noopener noreferrer" style="color:#2b6cb0; text-decoration:none; font-weight:600;">Personal Website</a>
      <a href="http://linkedin.com/in/samrat-biswas-ops" target="_blank" rel="noopener noreferrer" style="color:#2b6cb0; text-decoration:none; font-weight:600;">LinkedIn</a>
    </div>
  </div>
  </header>
  <section class="section site-container">
    <div class="section-head">
      <div><h2>Articles by Samrat Biswas</h2></div>
    </div>
    <div class="guide-grid">
      <article class="guide-card">
        <div class="card-meta"><span>Guest Post</span><span>6 min read</span></div>
        ...
        <a class="text-link" href="/how-universities-are-using-custom-software-solutions-to-build-smarter-digital-education-ecosystems/">Read the guide <span>&rarr;</span></a>
      </article>
    </div>
  </section>
  </main>
...
with open('author/samrat-biswas/index.html', 'w', encoding='utf-8') as f:
    f.write('\xef\xbb\xbf' + html)
print('Created author profile.')